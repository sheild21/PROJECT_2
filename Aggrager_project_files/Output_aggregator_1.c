        ...
        while(end!=2) {
            if (engine_1==1){
                ...
                if (r1==1){
                    ...
                    data1 = (int*) malloc(2*(row_len1_int-length_byte) * sizeof(char));

                    r2=fread(data1,2,row_len1_int-length_byte,input_engine1);
                    printf(" r2 %d\n",r2);
                    fwrite(data1,2,row_len1_int-length_byte,out_file);
                    printf("data %s\n",data1);
                    ...
                    if (r3==1){
                        ...
                        r4=fread(data2,2,row_len2_int-length_byte,input_engine2);
